    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doc_type', models.CharField(choices=[('CPF', 'CPF'), ('CNPJ', 'CNPJ')], max_length=4, verbose_name='Tipo do Documento')),
                ('doc_number', models.CharField(max_length=250, verbose_name='Número do Documento')),
        ...
        migrations.AddField(
            model_name='user',
            name='address',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='endereco', to='users.address', verbose_name='Endereço'),
        ),
        migrations.CreateModel(
            name='PhoneNumber',
            fields=[
                ...
                ('created', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('number', models.CharField(max_length=30, verbose_name='Número do telefone')),
                ('selected', models.BooleanField(default=False, verbose_name='Selecionado')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='celulares', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='user',
            name='phone_number',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='telefone', to='users.phonenumber', verbose_name='Telefone'),
        ),
        migrations.CreateModel(
            name='Role',
            fields=[
        ...
        migrations.AddField(
            model_name='role',
            name='role_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='role_types', to='users.roletype'),
        ),
    ]
