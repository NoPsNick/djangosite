    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance', models.DecimalField(decimal_places=2, max_digits=10, validators=[django.core.validators.MinValueValidator(Decimal('0.00')), django.core.validators.MaxValueValidator(Decimal('999.99'))], verbose_name='Saldo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='roles', to='users.roletype')),
            ],
            options={
                'verbose_name': 'cargo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', model_utils.fields.StatusField(choices=[('user_balance', 'Uso do saldo'), ('user_refund', 'Reembolso'), ('payment_create', 'Pagamento criado'), ('payment_success', 'Pagamento efetuado com sucesso'), ('payment_fail', 'Pagamento falhou')], default='user_balance', max_length=100, no_check_for_status=True, verbose_name='status')),
                ('status_changed', model_utils.fields.MonitorField(default=django.utils.timezone.now, monitor='status', verbose_name='status changed')),
                ('info', models.TextField(blank=True, max_length=500, null=True, verbose_name='Informação')),
                ('link', models.TextField(blank=True, max_length=500, null=True, verbose_name='Link')),
